...
output "connection_string" {
  ...
  value       = "Host=${azurerm_postgresql_flexible_server.main.fqdn};Database=${azurerm_postgresql_flexible_server_database.main.name};Username=${azurerm_postgresql_flexible_server.main.administrator_login};Password=${azurerm_postgresql_flexible_server.main.administrator_password}"
  sensitive   = true
}
